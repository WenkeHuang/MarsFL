...
from Methods.utils.finch import FINCH

class FPLSever(SeverMethod):
    NAME = 'FPLSever'

    def __init__(self, args, cfg):
        super(FPLSever, self).__init__(args, cfg)

    def proto_aggregation(self, online_clients, local_protos_list):
