...
python main.py --task domain_skew --dataset Digits --method Scaffold --device_id 1 --csv_log  --save_checkpoint &
...
python main.py --task domain_skew --dataset Digits --method FedProx --device_id 0 --csv_log  --save_checkpoint &
python main.py --task domain_skew --dataset Digits --method FedDyn --device_id 1 --csv_log  --save_checkpoint &
python main.py --task domain_skew --dataset Digits --method FedOpt --device_id 2 --csv_log  --save_checkpoint &
python main.py --task domain_skew --dataset Digits --method FedProto --device_id 3 --csv_log  --save_checkpoint &
python main.py --task domain_skew --dataset Digits --method FedNTD --device_id 0 --csv_log  --save_checkpoint &
python main.py --task domain_skew --dataset Digits --method FedNova --device_id 1 --csv_log  --save_checkpoint &
