...
python main.py --task domain_skew --dataset Digits --method MOON --device_id 4 --csv_log  --save_checkpoint &
python main.py --task domain_skew --dataset Digits --method FedDyn --device_id 5 --csv_log  --save_checkpoint &
...
python main.py --task domain_skew --dataset Digits --method FPL --device_id 1 --csv_log  --save_checkpoint &
