...
'''OfficeCaltech'''
python main.py --task domain_skew --dataset OfficeCaltech --method FedAVG --device_id 0 --csv_log --save_checkpoint &
python main.py --task domain_skew --dataset OfficeCaltech --method FedProx --device_id 1 --csv_log --csv_name mu_0.01 --save_checkpoint Local.FedProxLocal.mu 0.01&
python main.py --task domain_skew --dataset OfficeCaltech --method Scaffold --device_id 2 --csv_log  --save_checkpoint &
python main.py --task domain_skew --dataset OfficeCaltech --method MOON --device_id 3 --csv_name mu_1 --csv_log  --save_checkpoint Local.MOONLocal.mu 1&
python main.py --task domain_skew --dat  aset OfficeCaltech --method FedProc --device_id 4 --csv_log  --save_checkpoint &
