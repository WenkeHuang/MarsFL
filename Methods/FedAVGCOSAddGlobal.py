...
from utils.utils import EH, cal_client_weight
...
class FedAVGCOSAddGlobal(FederatedMethod):
    NAME = 'FedAVGCOSAddGlobal'

    def __init__(self, nets_list, client_domain_list, args, cfg):
        super(FedAVGCOSAddGlobal, self).__init__(nets_list, client_domain_list, args, cfg)
