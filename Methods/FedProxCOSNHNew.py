...
class FedProxCOSNHNew(FederatedMethod):
    NAME = 'FedProxCOSNHNew'

    def __init__(self, nets_list, client_domain_list, args, cfg):
        super(FedProxCOSNHNew, self).__init__(nets_list, client_domain_list, args, cfg)
    ...
    def agg_nets(self, online_clients_list, priloader_list):
        ...
        for domain in self.train_eval_loaders:
            ...
            # 将权重按照客户端大小排序然后保存
            freq_fc_sorted = freq_fc[np.argsort(online_clients_list)]
