...
class CRFL(FederatedMethod):
    NAME = 'CRFL'
    COMPATIBILITY = ['homogeneity']

    def __init__(self, nets_list, client_domain_list, args, cfg):
        super(CRFL, self).__init__(nets_list, client_domain_list, args, cfg)
    ...
    def local_update(self, priloader_list):
        ...
        self.submit_params_update_dict = self.local_model.loc_update(online_clients_list=self.online_clients_list, nets_list=self.nets_list, global_net=self.global_net,
    ...
    def sever_update(self, priloader_list):
        self.aggregation_weight_list = self.sever_model.sever_update(fed_aggregation=self.fed_aggregation,
                                                                     ...
                                                                     submit_params_update_dict=self.submit_params_update_dict,
