...
class COPADG(FederatedMethod):
    NAME = 'COPADG'
    COMPATIBILITY = ['homogeneity']

    def __init__(self, nets_list, client_domain_list, args, cfg):
        super(COPADG, self).__init__(nets_list, client_domain_list, args, cfg)
        self.head_dict = {}
    ...
    def sever_update(self, priloader_list):
        ...
        self.aggregation_weight_list, self.head_dict = self.sever_model.sever_update(fed_aggregation=self.fed_aggregation,
