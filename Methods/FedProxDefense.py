...
class FedProxDefense(FederatedMethod):
    NAME = 'FedProxDefense'
    COMPATIBILITY = ['homogeneity']

    def __init__(self, nets_list, client_domain_list, args, cfg):
        super(FedProxDefense, self).__init__(nets_list, client_domain_list, args, cfg)
    ...
    def sever_update(self, priloader_list):
        self.sever_model.sever_update(fed_aggregation=self.fed_aggregation, online_clients_list=self.online_clients_list,
