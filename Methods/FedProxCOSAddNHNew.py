...
class FedProxCOSAddNHNew(FederatedMethod):
    NAME = 'FedProxCOSAddNHNew'

    def __init__(self, nets_list, client_domain_list, args, cfg):
        super(FedProxCOSAddNHNew, self).__init__(nets_list, client_domain_list, args, cfg)
    ...
    def agg_nets(self, online_clients_list, priloader_list):
        ...
        for domain in self.train_eval_loaders:
            ...
            # temp_global_net.cls = copy.deepcopy(self.unbiased_fc)
