...
class ImageFolder_Custom(DatasetFolder):
    def __init__(self, data_name, root, train=True, transform=None, target_transform=None, subset_train_num=7, subset_capacity=10):
        ...
        self.imagefolder_obj = ImageFolder(self.root + 'VLCS/' + self.data_name.upper() + '/', self.transform, self.target_transform)
...
class FLVLCS(MultiDomainDataset):
    NAME = 'VLCS'
    SETTING = 'Domain'
    ...
    def __init__(self, args, cfg) -> None:
        ...
        self.domain_ratio = {'caltech': cfg.DATASET.domain_ratio, 'labelme': cfg.DATASET.domain_ratio,
                             'pascal': cfg.DATASET.domain_ratio, 'sun': cfg.DATASET.domain_ratio}

        self.train_eval_domain_ratio = {'caltech': cfg.DATASET.train_eval_domain_ratio, 'labelme': cfg.DATASET.train_eval_domain_ratio,
                                        'pascal': cfg.DATASET.train_eval_domain_ratio, 'sun': cfg.DATASET.train_eval_domain_ratio}
