...
class FLPACScomb(MultiDomainDataset):
    ...
    def get_data_loaders(self, selected_domain_list=[]):
        ...
        for _, domain in enumerate(self.domain_list):
            ...
            domain_training_dataset_dict[domain] = MyPACS(multi_domain_data_path() + 'PACS/', train='train', transform=train_transform, use_style=use_style, data_name=domain,
            ...
            domain_train_eval_dataset_dict[domain] = MyPACS(multi_domain_data_path() + 'PACS/', train='test', transform=train_transform, data_name=domain)
    ...
    def get_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), FLPACScomb.Nor_TRANSFORM])
        return transform
