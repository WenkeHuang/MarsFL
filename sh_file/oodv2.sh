...
python main.py --task OOD --dataset PACS --method Scaffold --device_id 4 --csv_log --save_checkpoint OOD.out_domain photo
python main.py --task OOD --dataset PACS --method Scaffold --device_id 4 --csv_log --save_checkpoint OOD.out_domain art_painting
python main.py --task OOD --dataset PACS --method Scaffold --device_id 4 --csv_log --save_checkpoint OOD.out_domain cartoon
python main.py --task OOD --dataset PACS --method Scaffold --device_id 4 --csv_log --save_checkpoint OOD.out_domain sketch

python main.py --task OOD --dataset Office31 --method Scaffold --device_id 4 --csv_log --save_checkpoint OOD.out_domain amazon
python main.py --task OOD --dataset Office31 --method Scaffold --device_id 4 --csv_log --save_checkpoint OOD.out_domain webcam
python main.py --task OOD --dataset Office31 --method Scaffold --device_id 4 --csv_log --save_checkpoint OOD.out_domain dslr
