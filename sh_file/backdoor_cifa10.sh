...
#python main.py --task label_skew --attack_type backdoor --dataset fl_cifar10 --method CRFL --device_id 5 \
...
#
#python main.py --task label_skew --attack_type backdoor --dataset fl_cifar10 --method RLR --device_id 5 \
#       --csv_log --csv_name beta_0.5_bcr_0.2 --save_checkpoint \
#       DATASET.parti_num 10 DATASET.beta 0.5 attack.backdoor.evils base_backdoor attack.bad_client_rate 0.2 &
