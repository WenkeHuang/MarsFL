...
'''
fl_fashionmnist 0.5 0.2 base_backdoor
'''
python main.py --task label_skew --attack_type backdoor --dataset fl_fashionmnist --method FedAVG --device_id 1 \
...
#python main.py --task label_skew --attack_type backdoor --dataset fl_fashionmnist --method CRFL --device_id 5 \
...
#
#python main.py --task label_skew --attack_type backdoor --dataset fl_fashionmnist --method RLR --device_id 5 \
#       --csv_log --csv_name beta_0.5_bcr_0.2 --save_checkpoint \
#       DATASET.parti_num 10 DATASET.beta 0.5 attack.backdoor.evils base_backdoor attack.bad_client_rate 0.2 &

'''
fl_fashionmnist 0.3 0.2 base_backdoor
'''
python main.py --task label_skew --attack_type backdoor --dataset fl_fashionmnist --method FedAVG --device_id 5 \
...
python main.py --task label_skew --attack_type backdoor --dataset fl_fashionmnist --method FedAVG --device_id 6 \
...
'''
fl_fashionmnist 0.5 0.2 semantic_backdoor
'''
python main.py --task label_skew --attack_type backdoor --dataset fl_fashionmnist --method FedAVG --device_id 7 \
       --csv_log --csv_name beta_0.5_bcr_0.2_MultiKrum --save_checkpoint  \
...
'''
fl_fashionmnist 0.3 0.2 semantic_backdoor
'''
python main.py --task label_skew --attack_type backdoor --dataset fl_fashionmnist --method FedAVG --device_id 6 \
       --csv_log --csv_name beta_0.3_bcr_0.2_MultiKrum --save_checkpoint  \
