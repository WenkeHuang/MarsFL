...
'''
python main.py --task label_skew --attack_type backdoor --dataset fl_syn --method FedAVG --device_id 2 \
...
'''
python main.py --task label_skew --attack_type backdoor --dataset fl_syn --method FedAVG --device_id 4 \
       --csv_log --csv_name beta_0.5_bcr_0.2_MultiKrum --save_checkpoint  \
