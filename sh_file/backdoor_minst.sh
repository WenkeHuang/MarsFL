...
'''
fl_mnist 0.5 0.2 base_backdoor
'''
#python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method FedAVG --device_id 0 \
...
#       --csv_log --csv_name beta_0.5_bcr_0.2_Bulyan --save_checkpoint  \
#       DATASET.parti_num 10 DATASET.beta 0.5 attack.backdoor.evils base_backdoor attack.bad_client_rate 0.2 FedAVG.global_method BulyanSever &
>>>>>>> 2fcb2f720b4dd2ca66fe046b6601c21af907ff77
...
#python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method FedAVG --device_id 1 \
...
#python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method FedAVG --device_id 1 \
#       --csv_log --csv_name beta_0.5_bcr_0.2_FLTrustSever_usps --save_checkpoint Sever.FLTrustSever.public_dataset_name pub_usps \
...
#
#python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method FedAVG --device_id 1 \
#       --csv_log --csv_name beta_0.5_bcr_0.2_SageFlowSever_usps --save_checkpoint  Sever.SageFlowSever.public_dataset_name pub_usps\
...
python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method CRFL --device_id 7 \
...
python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method RLR --device_id 7 \
       --csv_log --csv_name beta_0.5_bcr_0.2 --save_checkpoint \
       DATASET.parti_num 10 DATASET.beta 0.5 attack.backdoor.evils base_backdoor attack.bad_client_rate 0.2 &

'''
fl_mnist 0.3 0.2 base_backdoor
'''
#python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method FedAVG --device_id 2 \
...
#
#python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method FedAVG --device_id 3 \
...
#python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method FedAVG --device_id 3 \
#       --csv_log --csv_name beta_0.3_bcr_0.2_FLTrustSever_usps --save_checkpoint Sever.FLTrustSever.public_dataset_name pub_usps \
...
#
#python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method FedAVG --device_id 3 \
#       --csv_log --csv_name beta_0.3_bcr_0.2_SageFlowSever_usps --save_checkpoint  Sever.SageFlowSever.public_dataset_name pub_usps\
...
#python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method CRFL --device_id 5 \
...
#
#python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method RLR --device_id 5 \
#       --csv_log --csv_name beta_0.3_bcr_0.2 --save_checkpoint \
#       DATASET.parti_num 10 DATASET.beta 0.3 attack.backdoor.evils base_backdoor attack.bad_client_rate 0.2 &
=======
...
'''
fl_mnist 0.5 0.2 semantic_backdoor
'''
#python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method FedAVG --device_id 4 \
#       --csv_log --csv_name beta_0.5_bcr_0.2_MultiKrum --save_checkpoint  \
...
#
#python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method FedAVG --device_id 5 \
#       --csv_log --csv_name beta_0.5_bcr_0.2_Dnc --save_checkpoint  \
...
'''
fl_mnist 0.3 0.2 semantic_backdoor
'''
#python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method FedAVG --device_id 6 \
#       --csv_log --csv_name beta_0.3_bcr_0.2_MultiKrum --save_checkpoint  \
...
#python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method FedAVG --device_id 7 \
#       --csv_log --csv_name beta_0.3_bcr_0.2_Dnc --save_checkpoint  \
...
python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method FedAVG --device_id 7 \
       --csv_log --csv_name beta_0.3_bcr_0.2_FLTrustSever --save_checkpoint  Sever.FLTrustSever.public_dataset_name pub_usps\
...
python main.py --task label_skew --attack_type backdoor --dataset fl_mnist --method FedAVG --device_id 7 \
       --csv_log --csv_name beta_0.3_bcr_0.2_SageFlowSever --save_checkpoint Sever.SageFlowSever.public_dataset_name pub_usps \
