...
'''
fl_usps 0.5 0.2 base_backdoor
'''
#python main.py --task label_skew --attack_type backdoor --dataset fl_usps --method FedAVG --device_id 1 \
...
#
#python main.py --task label_skew --attack_type backdoor --dataset fl_usps --method FedAVG --device_id 3 \
...
<<<<<<< HEAD
#python main.py --task label_skew --attack_type backdoor --dataset fl_usps --method CRFL --device_id 5 \
...
#
#python main.py --task label_skew --attack_type backdoor --dataset fl_usps --method RLR --device_id 5 \
=======
...
'''
fl_usps 0.5 0.2 semantic_backdoor
'''
<<<<<<< HEAD
python main.py --task label_skew --attack_type backdoor --dataset fl_usps --method FedAVG --device_id 1 \
       --csv_log --csv_name beta_0.5_bcr_0.2_MultiKrum --save_checkpoint  \
