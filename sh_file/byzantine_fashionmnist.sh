...
'''
#python main.py --task label_skew --attack_type byzantine --dataset fl_fashionmnist --method FedProx --device_id 4 \
...
#
#python main.py --task label_skew --attack_type byzantine --dataset fl_fashionmnist --method FedProx --device_id 6 \
...
'''
fl_fashionmnist 0.5 0.4 RandomNoise
'''
...
'''
fl_fashionmnist 0.3 0.2 RandomNoise
'''
#python main.py --task label_skew --attack_type byzantine --dataset fl_fashionmnist --method FedProx --device_id 0 \
...
#
#python main.py --task label_skew --attack_type byzantine --dataset fl_fashionmnist --method FedProx --device_id 1 \
...
#
#python main.py --task label_skew --attack_type byzantine --dataset fl_fashionmnist --method FedProx --device_id 3 \
...
'''
FL_FashionMNIST-10 0.3 0.4 RandomNoise
'''
#python main.py --task label_skew --attack_type byzantine --dataset fl_fashionmnist --method FedProx --device_id 6 \
...
'''
Cifar-10 0.3 0.2 RandomNoise
'''
#python main.py --task label_skew --attack_type byzantine --dataset fl_cifar10 --method FedProx --device_id 0 \
#       --csv_log --csv_name beta_0.3_mu_0.01_bcr_0.2_MultiKrum --save_checkpoint Local.FedProxLocal.mu 0.01 \
#       DATASET.parti_num 10 DATASET.beta 0.3 attack.byzantine.evils RandomNoise attack.bad_client_rate 0.2 FedProx.global_method MultiKrumSever &
#
#python main.py --task label_skew --attack_type byzantine --dataset fl_cifar10 --method FedProx --device_id 0 \
...
'''
fl_fashionmnist 0.5 0.2 PairFlip
'''
#python main.py --task label_skew --attack_type byzantine --dataset fl_fashionmnist --method FedProx --device_id 0 \
#       --csv_log --csv_name beta_0.5_mu_0.01_bcr_0.2_MultiKrum --save_checkpoint Local.FedProxLocal.mu 0.01 \
...
'''
fl_fashionmnist 0.5 0.4 PairFlip
'''
#python main.py --task label_skew --attack_type byzantine --dataset fl_fashionmnist --method FedProx --device_id 2 \
#       --csv_log --csv_name beta_0.5_mu_0.01_bcr_0.4_MultiKrum --save_checkpoint Local.FedProxLocal.mu 0.01 \
...
'''
fl_fashionmnist 0.3 0.2 PairFlip
'''
#python main.py --task label_skew --attack_type byzantine --dataset fl_fashionmnist --method FedProx --device_id 0 \
#       --csv_log --csv_name beta_0.3_mu_0.01_bcr_0.2_MultiKrum --save_checkpoint Local.FedProxLocal.mu 0.01 \
...
'''
FL_FashionMNIST-10 0.3 0.4 PairFlip
'''
#python main.py --task label_skew --attack_type byzantine --dataset fl_fashionmnist --method FedProx --device_id 2 \
#       --csv_log --csv_name beta_0.3_mu_0.01_bcr_0.4_MultiKrum --save_checkpoint Local.FedProxLocal.mu 0.01 \
