...
# Tiny Imagenet
#python main.py --task label_skew --attack_type byzantine --dataset fl_tinyimagenet --method FedProx --device_id 5 --csv_log --csv_name beta_0.3_mu_0.001 --save_checkpoint Local.FedProxLocal.mu 0.001 DATASET.parti_num 10 DATASET.beta 0.3 &
#python main.py --task label_skew --attack_type byzantine --dataset fl_tinyimagenet --method FedProx --device_id 6 --csv_log --csv_name beta_0.5_mu_0.001 --save_checkpoint Local.FedProxLocal.mu 0.001 DATASET.parti_num 10 DATASET.beta 0.5 &
